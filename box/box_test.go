...
func TestBoxConstrain1(t *testing.T) {
	b1 := NewWithXYWidthHeight(10, 10, 10, 10)
	b2 := NewWithXYWidthHeight(0, 0, 100, 100)
	output, _ := b1.ConstrainedTo(b2)
	assert.Equal(t, *output, b1)
}

func TestBoxConstrain2(t *testing.T) {
	b1 := NewWithXYWidthHeight(-10, 0, 20, 20)
	b2 := NewWithXYWidthHeight(0, 0, 100, 100)
	output, _ := b1.ConstrainedTo(b2)
	expectedOutput := NewWithXYWidthHeight(0, 0, 20, 20)
	assert.Equal(t, *output, expectedOutput)
}

func TestBoxConstrain3(t *testing.T) {
	b1 := NewWithXYWidthHeight(-10, 0, 120, 20)
	b2 := NewWithXYWidthHeight(0, 0, 100, 100)
...
func TestBoxConstrain4(t *testing.T) {
	b1 := NewWithXYWidthHeight(10, 130, 20, 20)
	b2 := NewWithXYWidthHeight(0, 0, 100, 100)
	output, _ := b1.ConstrainedTo(b2)
	expectedOutput := NewWithXYWidthHeight(10, 80, 20, 20)
	assert.Equal(t, *output, expectedOutput)
}

func TestBoxConstrain5(t *testing.T) {
	b1 := NewWithXYWidthHeight(2432, -76, 756, 756)
	b2 := NewWithXYWidthHeight(0, 0, 3024, 4032)
...
func TestIntersects1(t *testing.T) {
	b1 := NewWithXYWidthHeight(0, 0, 20, 20)
...
func TestIntersects2(t *testing.T) {
	b1 := NewWithXYWidthHeight(0, 0, 20, 20)
	b2 := NewWithXYWidthHeight(30, 30, 5, 5)
...
func TestIntersects3(t *testing.T) {
	b1 := NewWithXYWidthHeight(0, 0, 20, 20)
	b2 := NewWithXYWidthHeight(10, 10, 20, 20)
	intersects := b1.Intersects(b2)
	assert.True(t, intersects)
}
...
func TestIntersects4(t *testing.T) {
	b1 := NewWithXYWidthHeight(0, 0, 20, 20)
	b2 := NewWithXYWidthHeight(10, 10, 5, 5)
	intersects := b1.Intersects(b2)
	assert.True(t, intersects)
}
...
func TestIntersectionBox1(t *testing.T) {
	b1 := NewWithXYWidthHeight(0, 0, 10, 10)
	b2 := NewWithXYWidthHeight(5, 5, 10, 10)
	expected := NewWithXYWidthHeight(5, 5, 5, 5)
...
func TestIntersectionBox2(t *testing.T) {
	b1 := NewWithXYWidthHeight(0, 0, 10, 10)
	b2 := NewWithXYWidthHeight(30, 30, 10, 10)
...
func TestPercentOverlapping1(t *testing.T) {
	b1 := NewWithXYWidthHeight(0, 0, 10, 10)
	b2 := NewWithXYWidthHeight(20, 20, 10, 10)
